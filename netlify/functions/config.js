...
export default async () => {
  ...
  return json({
    ...
    meta_journey_events: ["PageView", "TestStarted", "ServiceAreaQualified", "Lead", "QualifiedLead", "WhatsAppIntent"],
    meta_pageview_capi_coverage: true,
    meta_pageview_pixel_capi_dedup: true,
    meta_whatsapp_intent_mode: "diagnostic_in_area_only",
    meta_capi_enhanced_matching: ["email", "phone", "first_name", "last_name", "external_id", "client_ip", "client_user_agent", "fbp", "fbc", "fbclid_fallback"],
    ...
    tracking: {
      ...
      meta_service_area_event: "ServiceAreaQualified",
      meta_journey_endpoint: "/api/meta/journey",
